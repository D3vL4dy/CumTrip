	...
	<contain>
		<div class="Page_rwrap">
			...
			<form id="find_passSet_form">
				<div class="nvbew1">
					<label class="f4 ercfn2">새 비밀번호</label>
					<input type="text" name="set_passWord" id="set_passWord" class="nbg2 form-control control-label col-sm-3"><br>
				</div>
				<div class="nvbew1">
					<label class="f4 ercfn2">새 비밀번호 재입력</label>
					<input type="text" id="set_passWord2" class="nbg2 form-control control-label col-sm-3"><br>
				</div>
				<div class="passSet_box"></div>
				<input type="button" value="비밀번호변경" id="bo">
			</form>
		</div>
	</contain>
