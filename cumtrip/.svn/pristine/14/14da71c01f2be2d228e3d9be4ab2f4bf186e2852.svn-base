...
<div class="mypage_wrap">
	<div class="mypage__wrapSub">
		...
		<div class="mypage_boxContain">
			<h3 class="mypage_boxLike_h3 f1">여행 좋아요 목록</h3>
			<ul class="mypage_boxLike">
				<li class="mypage_boxLike_li mypage_boxLike_li_t">
					<div class="m_Like_no_t f4">사진</div>
					<div class="m_Like_poto_t f4">여행지</div>
					<div class="m_Like_name_t f4">지역</div>
					<div class="m_Like_2_t f4">찜여부</div>
				</li>	
				<span class="mypage_boxLike_span">
				</span>
			<h3 class="mypage_boxLike_h3 f1">리뷰 좋아요 목록</h3>
			<ul class="mypage_boxLike">
				<li class="mypage_boxLike_li mypage_boxLike_li_t">
					<div class="m_Like_no_t f4">장소</div>
					<div class="m_Like_poto_t f4">리뷰</div>
					<div class="m_Like_name_t f4">작성일</div>
					<div class="m_Like_2_t f4">찜여부</div>
				</li>	
