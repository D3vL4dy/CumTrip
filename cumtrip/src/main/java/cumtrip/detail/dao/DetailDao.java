...
public class DetailDao {
	...
	public int commentdel(SqlMapClient smc, String comno) throws SQLException{
		int result = 0; 
		
		result = smc.delete("review.commentdel", comno);
		
		return result;
	}
	public int commentmod(SqlMapClient smc, M_commentVO vo )throws SQLException{
		int result = 0; 
		
		result = smc.update("review.commentmod", vo);
		
		return result;
		
	}
	public int commentsdel(SqlMapClient smc, String scono) throws SQLException{
		int result = 0; 
		
		result = smc.delete("review.commentsdel", scono);
		
		return result;
	}
	public int commentsmod(SqlMapClient smc, S_commentVO vo )throws SQLException{
		int result = 0; 
		
		result = smc.update("review.commentsmod", vo);
