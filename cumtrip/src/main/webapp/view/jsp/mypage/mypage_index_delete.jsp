...
<div class="mypage_wrap">
	<div class="mypage__wrapSub">
		<div class="mypage__wrap_topBox">
			<span><a href="<%= request.getContextPath() %>/view/jsp/mypage/mypage_index.jsp" style="background: #111; color:#fff;" class="f4">고객정보</a></span>
		...
		<div class="mypage_boxContain">
			<div class="mypage_delectBox">
				<h1 class="f4 rte1">정말 탈퇴하시겠습니까?</h1>
				<input type="button" id="delete_member" value="탈퇴" style=" line-height: 30px; ">
				<input type="button" id="reset_delete" value="취소" style=" line-height: 30px;"></div>
			</div>
		</div>
	</div>
</div>
